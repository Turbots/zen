...
# kbld relocate -f images.lock --lock-output images-relocated.lock --repository harbor.tanzu.be/library/build-service
...
kp secret create harbor-credentials -n default --registry harbor.tanzu.be --registry-user admin

kp image create zen -n default --tag harbor.tanzu.be/library/zen:latest --blob https://gitlab.tanzu.be/root/zen
